...
![Industrial wide expert parallelism](../assets/subchapters/13/nvidia-wide-ep-moe-2025.webp)
...
![NVIDIA Vera CPU architecture](../assets/subchapters/13/nvidia-vera-cpu-architecture.png)
