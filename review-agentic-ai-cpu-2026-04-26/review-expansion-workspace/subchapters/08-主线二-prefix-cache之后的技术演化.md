...
![Agentic KV-aware placement and routing](../assets/subchapters/08/nvidia-dynamo-agentic-kv-readwrite-2026.webp)
...
![KV lifecycle and event-driven state management](../assets/subchapters/08/agentic-kv-memory-hierarchy.svg)
