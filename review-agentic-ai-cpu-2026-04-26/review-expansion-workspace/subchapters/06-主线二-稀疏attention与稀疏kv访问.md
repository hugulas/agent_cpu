...
![NOSA sparse attention memory hierarchy](../assets/subchapters/06/nosa-01.png)
...
![ScoutAttention layer-ahead CPU pre-computation](../assets/subchapters/06/scoutattn-1.png)
