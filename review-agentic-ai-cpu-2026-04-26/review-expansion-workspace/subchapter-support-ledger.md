...
| --- | --- | --- | --- | --- | --- |
| 1 | `01-主线一-微观问题-kernel-launch-tax.md` | `in_progress` | `S005 S038 S039 S040` | 加 `2` 张图、补 `19x` 和 `1.7x`、给关键判断加近旁引用 | 进行中 |
| 2 | `02-主线一-宏观问题-状态驱动调度链.md` | `pending` | `S005 S003 S021 S024` | 补同步链图、补 queue/dispatch 数据、加逐段引用 | 未开始 |
| 3 | `03-主线一-图化编译与运行时图化.md` | `pending` | `S038 S039 S040` | 补 graph mode 图、capture/compile 代价、加逐段引用 | 未开始 |
| 4 | `04-主线一-图化编译在服务化推理中的利弊.md` | `pending` | `S039 S040 S024 S025` | 补收益-代价对照表、加动态 fallback 证据 | 未开始 |
