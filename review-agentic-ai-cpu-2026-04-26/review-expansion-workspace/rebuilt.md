...
![Agentic KV read-write ratio](../../assets/agentic-kv-read-write-ratio.webp)
...
![KV memory hierarchy](../../assets/agentic-kv-memory-hierarchy.svg)
...
![NOSA sparse attention memory hierarchy](../../assets/extracted/nosa-01.png)
...
![ScoutAttention layer-ahead CPU pre-computation](../../assets/extracted/scoutattn-1.png)
...
![Agentic KV reuse and routing](../../assets/nvidia-dynamo-agentic-kv-readwrite-2026.webp)
...
![KV read-write reuse pressure](../../assets/agentic-kv-read-write-ratio.webp)
...
![Agentic KV-aware placement and routing](../../assets/nvidia-dynamo-agentic-kv-readwrite-2026.webp)
...
![KV lifecycle and event-driven state management](../../assets/agentic-kv-memory-hierarchy.svg)
...
![FluxMoE expert residency architecture](../../assets/extracted/fluxmoe-01.png)
...
![Speculative expert offloading overlap](../../assets/extracted/spec-experts-01.png)
...
![Expert dispatch topology and hotspot distribution](../../assets/deepep-normal-dispatch.png)
...
![Wide expert parallelism and topology-aware placement](../../assets/nvidia-wide-ep-moe-2025.webp)
